 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var zt=function(e,t,r,i){var o,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,i);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,r,a):o(t,r))||a);return n>3&&a&&Object.defineProperty(t,r,a),a};let Tt=class extends tt{constructor(){super(...arguments),this.width=20,this.enabled=!1,this.label="Click to check",this.userSelectable=!0}handleClick(){this.enabled=!this.enabled;const e=new CustomEvent("checked",{detail:{status:this.enabled}});this.dispatchEvent(e)}get value(){return this.enabled?"true":"false"}set value(e){this.enabled="true"===e}render(){return Ie`<button
